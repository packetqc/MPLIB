...
```/${ProjName}/Middlewares/ST/touchgfx_components/gpu2d```
```${ProjName}/Middlewares/ST/touchgfx/3rdparty/libjpeg/include```
```/${ProjName}/Drivers/STM32N6xx_HAL_Driver/Inc```
```/${ProjName}/TouchGFX/assets```
```/${ProjName}/TouchGFX/target/generated```
```${ProjName}/TouchGFX/target```
```/${ProjName}/Core/Inc```
```/STM32N6570-DK/Drivers/STM32N6xx_HAL_Driver/Inc```
```/STM32N6570-DK/Drivers/CMSIS/Device/ST/STM32N6xx/Include```
